...
const Dashboard = () => {
    ...
    const [dashbaordData, setDashboardData] = useState(dashboardDummyData)
  return (
    <div>
        <Title align='left' font='outfit' title="Dashboard"
        subTitle='Monitor your room listings, track bookings and analuse revenue-all in one place. Stay
